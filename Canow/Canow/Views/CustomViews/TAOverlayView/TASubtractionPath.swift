...
public class TARectangularSubtractionPath: TABaseSubtractionPath {
    ...
    ///
    public init(frame: CGRect, horizontalPadding: CGFloat = 0, verticalPadding: CGFloat = 0, radius: CGFloat = 0) {
    ...
    fileprivate override func createPath() -> UIBezierPath {
        ...
        return UIBezierPath(roundedRect: rect, cornerRadius: self.radius)
    }
